...
void I2C_Begin (uint32_t CLK_Freq){     // Enable I2C & Init I2C Peripheral & Set CLK Pin Freq
    ...
    I2C->CR2  = ACK ;
    I2C->OARL = (uint8_t)Default_OwnAddress;           // Set STM8 Own Address LSB       
    I2C->OARH = (uint8_t)((uint8_t)(Address_Mode | I2C_OARH_ADDCONF) | 
                (uint8_t)((Default_OwnAddress & (uint16_t)0x0300) >> (uint8_t)7));      
